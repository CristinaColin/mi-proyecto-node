...
router.get('/', (req, res) => {
    ...
    res.render('horario', { pais: 'SERVIDOR', hora: date }); // Renderiza la vista "horario.ejs"
...
router.get('/country/:pais', (req, res) => {
    ...
    res.render('horario', { pais: pais.toUpperCase(), hora: date }); // Renderiza la vista "horario.ejs"
});
